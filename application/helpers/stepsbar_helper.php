...
function project_steps($step_project_id){
	$CI =& get_instance();
	...
	$data['stepData'] = $CI->Projectdashboard_model->get_project_steps_data($step_project_id);
	$data['step_project_id'] = $step_project_id;
	$CI->load->view('dashboard/project_steps_bar_view', $data);
