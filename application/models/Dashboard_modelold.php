...
//=========================
    public function get_puri_project_count($project_sector_id,$project_group_id,$project_category_id,$project_area_id,$project_wing_id,$project_division_id){
    ...
    if($project_wing_id > 0){
     ...
     public function get_nonpuri_project_count($project_sector_id,$project_group_id,$project_category_id,$project_area_id,$project_wing_id,$project_division_id){
       $this->db->select('project_conceptualisation_stage.*');
       if($project_sector_id > 0){
        $this->db->where('project_conceptualisation_stage.project_sector', $project_sector_id);  
      }
    ...
    if($project_wing_id > 0){
     ...
     public function get_circle1_project_count($project_sector_id,$project_group_id,$project_category_id,$project_area_id,$project_wing_id,$project_division_id){
       $this->db->select('project_conceptualisation_stage.*');
       if($project_sector_id > 0){
        $this->db->where('project_conceptualisation_stage.project_sector', $project_sector_id);  
      }
    ...
    if($project_wing_id > 0){
     ...
     public function get_circle2_project_count($project_sector_id,$project_group_id,$project_category_id,$project_area_id,$project_wing_id,$project_division_id){
       $this->db->select('project_conceptualisation_stage.*');
       if($project_sector_id > 0){
        $this->db->where('project_conceptualisation_stage.project_sector', $project_sector_id);  
      }
    ...
    if($project_wing_id > 0){
      ...
      public function get_circle3_project_count($project_sector_id,$project_group_id,$project_category_id,$project_area_id,$project_wing_id,$project_division_id){
       $this->db->select('project_conceptualisation_stage.*');
       if($project_sector_id > 0){
        $this->db->where('project_conceptualisation_stage.project_sector', $project_sector_id);  
      }
...
");
    ...
    public function get_financial_project_cost($project_sector_id,$project_group_id,$project_category_id,$project_area_id,$project_wing_id,$project_division_id){
...
");
    ...
    public function get_project_details($project_sector_id, $project_group_id,$project_category_id,$project_area_id,$project_wing_id,$project_division_id ){
      ...
      //$this->db->select('project_conceptualisation_stage.*,pa.agreement_cost,pa.agreement_date as project_start_date,pa.agreement_end_date as project_end_date');
	  if($project_sector_id > 0){
        $this->db->where('project_conceptualisation_stage.project_sector', $project_sector_id);  
      }
      if($project_group_id > 0){
    ...
    public function get_issues_dashboard(){

  
         //$query = $this->db->query("SELECT pc.id,pc.project_name,pt.project_type as category, pgs.project_start_date as start_date,pgs.project_end_date as end_date,COUNT(distinct case when usi.current_status='Y' then usi.id end) as closeissue, COUNT(distinct case when usi.current_status='N' then usi.id end) as openissue from `project_creation` pc join update_status_issues usi ON pc.id = usi.project_id join project_type_master pt ON pt.id = pc.cat_id LEFT join project_aggrement_stage pgs ON pgs.project_id = pc.id group by usi.project_id");
...
public function construction_project_listscnt($project_sector_id,$project_group_id,$project_category_id,$project_area_id,$project_wing_id,$project_division_id)
   {
 ...
 WHERE a.approve_status='Y' AND b.project_id IS NULL
  ...
  if($query -> num_rows() >= 1){ return $query->result(); }
    ...
    public function completed_project_listscnt($project_sector_id,$project_group_id,$project_category_id,$project_area_id,$project_wing_id,$project_division_id)
    {
...
");
	 ...
	 //echo $this->db->last_query(); die();
      return $query->result_array();  
	   ...
	   public function get_project_paid_amount($project_sector_id,$project_group_id,$project_category_id,$project_area_id,$project_wing_id,$project_division_id) {
    ...
    if($project_wing_id > 0){
	 ...
	 // echo $this->db->last_query();
	  ...
	  public function get_delay_proj($project_group_id,$project_category_id,$project_area_id,$project_wing_id,$project_division_id){
...
");
	  ...
	  public function get_all_pre_contruction_proj_cnt($project_group_id,$project_category_id,$project_area_id,$project_wing_id,$project_division_id){
...
");
	...
	// echo $this->db->last_query(); die();
	  ...
	  public function get_all_pre_contruction_status($project_group_id,$project_category_id,$project_area_id,$project_wing_id,$project_division_id){
		if($project_group_id > 0){
        $condition = "AND pd.project_group='$project_group_id'"; 
      }
    if($project_category_id > 0){
...
");
    ...
    function get_pre_contruction_activity_chart_data($project_group_id,$project_category_id,$project_area_id,$project_wing_id,$project_division_id){
...
");
  ...
  // echo $this->db->last_query(); die();
    ...
    public function Preconstruction_project_listscnt($project_sector_id,$project_group_id,$project_category_id,$project_area_id,$project_wing_id,$project_division_id)
    {
   ...
   function tendering_status_overview() {
   ...
   function tendering_pending_overview(){
