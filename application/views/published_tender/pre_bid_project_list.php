...
<section class="content">
        ...
        <div class="block-header">
          <h4>Project Tendering - Pre Bid</h4>
        </div>
            </div>
            <div class="col-md-6">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="">
							  ...
							  $project_status_ar =$CI->Published_tender_model->fetchSingledata('tendering_pre_bid', 'project_id', $app->project_id); 
								  ...
								  $status_view = "In Progress";
                                      ...
                                      ?>
                                        <tr>
                                            ...
                                            <a class="btn bg-primary waves-effect" title="" href="<?php echo base_url();?>Pre_bid_conference/manage?project_id=<?php echo base64_encode($app->project_id); ?>">
