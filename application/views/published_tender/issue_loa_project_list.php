                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="">
							  ...
							  $project_status_ar =$CI->Published_tender_model->fetchSingledata('tendering_issue_of_loa', 'project_id', $app->project_id); 
								  ...
								  $status_view = "In Progress";
                                      ...
                                      ?>
                                        <tr>
                                            ...
                                            <a class="btn bg-primary waves-effect" title="" href="<?php echo base_url();?>Issue_of_LoA/manage?project_id=<?php echo base64_encode($app->project_id); ?>">
