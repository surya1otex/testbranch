...
<section class="content">
  <div class="container-fluid">
    ...
    <div class="row clearfix ">
        ...
        <?php
        $form_action = site_url().'/Tender_Report/ajax_project_report';
    ?>
...
var project_status = $('#project_status').val();
    ...
    if(project_id == '' || checkbox_value == ''){
      ...
      $.ajax({
            url:"<?php echo site_url(); ?>/Tender_Report/ajax_project_individual_report",
              method:"POST",
              data:{
  ...
  if(report_type == 'Summary'){
    var checkbox_value1 = "";
    // $("input:checkbox[name=summ_view_data[]]:checked").each(function () {
    ...
    if(checkbox_value1 == ''){
      ...
      $.ajax({
            url:"<?php echo site_url(); ?>/Tender_Report/ajax_project_summary_report",
              method:"POST",
              data:{
                report_type:report_type,
...
<script type="text/javascript">
  ...
  function generateFunction(){
    ...
    var project_status = $("#project_status").val(); 
             ...
             $.ajax({
              url:"<?php echo base_url(); ?>Tender_Report/get_project_list",
              method:"POST",
