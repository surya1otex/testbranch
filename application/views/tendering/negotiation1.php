                        ...
                        <div class="body">
                            <div class="bidder-details-container m-b-15" id="nego_bid_value">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 p-r-0">
                                     ...
                                     <div class="col-md-2 p-r-0">
                                        ...
                                        <input class="form-control txtQty bidvalue" type="hidden"  placeholder="Negotiated Bid Value" name="negobidvalue[]" id="negotiationbidvalue<?php echo $k ?>" value="<?php echo number_format($Tvalue['neo_bid_value'],2); ?>">
                              ...
                              <!-- =========== -->
                                 ...
                                 <?php
                                     if(!empty($negotiation_added_data)){
                                 ?>
                               
                                <?php 
                                  $k = 1;
                                  $get_same_datacnt = count($negotiation_added_data);
                                  foreach ($negotiation_added_data as $Tvalue) {
                                  if($k == 1){
                                ...
                                <div class="row">
                                    <div class="col-md-2 p-r-0">
                                         ...
                                         <input class="form-control bidder_ref_nom" type="text" readonly  placeholder="Successful Bidder Ref No/Name" name="negobiddername[]" value="<?php echo $Tvalue['biddername']; ?>">
                                ...
                                <?php 
                                 ...
                                 ?>
                                    <div id="bidder-details-row<?php echo $k; ?>" style="display: none;">
                                        <div class="row">
                                            <div class="col-md-2 p-r-0">
                                                <input class="form-control bidder_ref_nom" readonly type="text" placeholder="Successful Bidder Ref No/Name" readonly value="<?php echo $Tvalue['bidder_name']; ?>" name="negobiddername[]">
                                                <input class="form-control" type="hidden" name="negobidderid[]"  value="<?php echo $Tvalue['bidder_ref_no']; ?>">
...
// end of options //
 ...
 function checkSubmitStatus( event ){
       ...
       $('#nego_bid_value').find('.bidvalue').each(function (i, input) {
            ...
            // if ($(input).val() == '') {
            //     $(input).after("<span class='error' style='color:#ff0000'>Negotiated Bid Value.</span>");
