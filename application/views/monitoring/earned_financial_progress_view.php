...
<!--         <img src="http://flexslider.woothemes.com/images/kitchen_adventurer_donut.jpg" alt="Los Angeles" style="width:100%;"> -->
      </div>

      <div class="item">
 <!--        <img src="http://flexslider.woothemes.com/images/kitchen_adventurer_caramel.jpg" alt="Chicago" style="width:100%;"> -->
      </div>
    
      <div class="item">
<!--         <img src="http://flexslider.woothemes.com/images/kitchen_adventurer_lemon.jpg" alt="New york" style="width:100%;"> -->
      </div>
    </div>
...
//     alert(response.imgblocks);

    // console.log(response.imgblocks);
    $('.carousel-indicators').html(response.dotsblock);
    $('.carousel-inner').html(response.imgblocks);
