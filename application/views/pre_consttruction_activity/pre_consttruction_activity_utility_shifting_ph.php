...
<?php echo form_open_multipart('Pre_consttruction_activity_utility_shifting_ph/manage', array('name' => 'pre_consttruction_activity_utility_shifting_ph','id' => 'pre_consttruction_activity_utility_shifting_ph')); ?>
			...
			<div class="row clearfix">
                   ...
                   <!--         <div class="row clearfix m-b-30"> 
                            ...
                            <div class="row clearfix">
                               <div class="col-md-4">
                                    ...
                                    <input class="form-control txtQty" type="text" placeholder="Length of pipeline (LHS)" name="length_of_pipeline_tobe_shifted_lhs" id="length_of_pipeline_tobe_shifted_lhs" value="<?php if(empty($utility_ph)){ echo set_value('length_of_pipeline_tobe_shifted_lhs'); }?><?php echo $utility_ph[0]['length_of_pipeline_tobe_shifted_lhs'] ?>">
                                 ...
                                 <div class="col-md-4">
                                    ...
                                    <input class="form-control txtQty" type="text" placeholder="Length of pipeline ( RHS )"  name="length_of_pipeline_tobe_shifted_rhs" value="<?php if(empty($utility_ph)){ echo set_value('length_of_pipeline_tobe_shifted_rhs'); }?><?php echo $utility_ph[0]['length_of_pipeline_tobe_shifted_rhs'] ?>">
                                ...
                                <div class="col-md-4">
                                    <p>
                                     ...
                                     <input type="text" class="datepicker form-control" placeholder="Please choose a date..." name="target_end_date" value="<?php if(empty($utility_ph)){ echo set_value('target_end_date'); }?><?php echo $utility_ph[0]['target_end_date'] ?>">
               ...
               <!-- Location Details Start-->
                   ...
                   <div id="container1" class="row clearfix">
                         <?php 
                      $k = 1;
                 $get_same_datacnt = count($utility_ph_location);
              
                foreach ($utility_ph_location as $sameD) {
                  if($k == 1){
...
<i class="material-icons">add</i>
                                ...
                                <div class="col-md-3">
                                    <p>
                                     ...
                                     <select class="form-control show-tick" name="status_joint_verification">
                                        <option value="Yes" <?php echo set_select('status_joint_verification','Yes', ( !empty($utility_ph[0]['status_joint_verification']) &&
                                      $utility_ph[0]['status_joint_verification'] == "Yes" ? TRUE : FALSE )); ?>>Yes</option>
                                        <option value="No" <?php echo set_select('status_joint_verification','No', ( !empty($utility_ph[0]['status_joint_verification']) &&
                                      $utility_ph[0]['status_joint_verification'] == "No" ? TRUE : FALSE )); ?>>No</option>
                                        <option value="In Progress" <?php echo set_select('status_joint_verification','In Progress', ( !empty($utility_ph[0]['status_joint_verification']) &&
                                      $utility_ph[0]['status_joint_verification'] == "In Progress" ? TRUE : FALSE )); ?>>In Progress</option>
                                        <option value="N.A" <?php echo set_select('status_joint_verification','N.A', ( !empty($utility_ph[0]['status_joint_verification']) &&
                                      $utility_ph[0]['status_joint_verification'] == "N.A" ? TRUE : FALSE )); ?>>N.A.</option>
                                    </select>
                                </div>
            ...
            <?php if (!empty($utility_ph[0]['file_joint_verification'])) { ?>
      <a href="<?php echo base_url();?>uploads/files/shifting_ph/<?php echo $utility_ph[0]['file_joint_verification']; ?>" target="_blank">
    ...
    <?php } ?>
                                ...
                                <div class="col-md-3">
                                    <p>
                                     ...
                                     <select class="form-control show-tick" name="status_fund_for_utility_shifting">
                                        <option value="Yes" <?php echo set_select('status_fund_for_utility_shifting','Yes', ( !empty($utility_ph[0]['status_fund_for_utility_shifting']) &&
                                      $utility_ph[0]['status_fund_for_utility_shifting'] == "Yes" ? TRUE : FALSE )); ?>>Yes</option>
                                        <option value="No" <?php echo set_select('status_fund_for_utility_shifting','No', ( !empty($utility_ph[0]['status_fund_for_utility_shifting']) &&
                                      $utility_ph[0]['status_fund_for_utility_shifting'] == "No" ? TRUE : FALSE )); ?>>No</option>
                                        <option value="In Progress" <?php echo set_select('status_fund_for_utility_shifting','In Progress', ( !empty($utility_ph[0]['status_fund_for_utility_shifting']) &&
                                      $utility_ph[0]['status_fund_for_utility_shifting'] == "In Progress" ? TRUE : FALSE )); ?>>In Progress</option>
                                        <option value="N.A" <?php echo set_select('status_fund_for_utility_shifting','N.A', ( !empty($utility_ph[0]['status_fund_for_utility_shifting']) &&
                                      $utility_ph[0]['status_fund_for_utility_shifting'] == "N.A" ? TRUE : FALSE )); ?>>N.A.</option>
                                    </select>
                                </div>
            ...
            <?php if (!empty($utility_ph[0]['file_fund_for_utility_shifting'])) { ?>
      <a href="<?php echo base_url();?>uploads/files/shifting_ph/<?php echo $utility_ph[0]['file_fund_for_utility_shifting']; ?>" target="_blank">
        <i class="fa fa-download fa-2x" aria-hidden="true"></i>
      </a>
    <?php } ?>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <p>
                                     ...
                                     <select class="form-control show-tick" name="status_tender_awarded">
                                        <option value="Yes" <?php echo set_select('status_tender_awarded','Yes', ( !empty($utility_ph[0]['status_tender_awarded']) &&
                                      $utility_ph[0]['status_tender_awarded'] == "Yes" ? TRUE : FALSE )); ?>>Yes</option>
                                        <option value="No" <?php echo set_select('status_tender_awarded','No', ( !empty($utility_ph[0]['status_tender_awarded']) &&
                                      $utility_ph[0]['status_tender_awarded'] == "No" ? TRUE : FALSE )); ?>>No</option>
                                        <option value="In Progress" <?php echo set_select('status_tender_awarded','In Progress', ( !empty($utility_ph[0]['status_tender_awarded']) &&
                                      $utility_ph[0]['status_tender_awarded'] == "In Progress" ? TRUE : FALSE )); ?>>In Progress</option>
                                        <option value="N.A" <?php echo set_select('status_tender_awarded','N.A', ( !empty($utility_ph[0]['status_tender_awarded']) &&
                                      $utility_ph[0]['status_tender_awarded'] == "N.A" ? TRUE : FALSE )); ?>>N.A.</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <p>
                                     ...
                                     <?php echo form_error('file_tender_awarded', '<div class="error">', '</div>'); ?>
                                                 <?php if (!empty($utility_ph[0]['file_tender_awarded'])) { ?>
      <a href="<?php echo base_url();?>uploads/files/shifting_ph/<?php echo $utility_ph[0]['file_tender_awarded']; ?>" target="_blank">
        <i class="fa fa-download fa-2x" aria-hidden="true"></i>
      </a>
    <?php } ?>
                                </div>
                       ...
                       <div class="body"> 
                          <div class="cloneBox1 m-b-15">
                            <div class="row clearfix">
                                <div class="col-md-4">
                                    <p>
                                     ...
                                     <input class="form-control txtQty" type="text" placeholder="poles shifted" name="progress_length_of_line_tobe_shifted_lhs" id="progress_length_of_line_tobe_shifted_lhs" value="<?php if(empty($utility_ph)){ echo set_value('progress_length_of_line_tobe_shifted_lhs'); }?><?php echo $utility_ph[0]['progress_length_of_line_tobe_shifted_lhs'] ?>">
                                ...
                                <div class="col-md-4">
                                    <p>
                                     ...
                                     <input class="form-control txtQty" type="text" placeholder="poles shifted" name="progress_length_of_line_tobe_shifted_rhs" value="<?php if(empty($utility_ph)){ echo set_value('progress_length_of_line_tobe_shifted_rhs'); }?><?php echo $utility_ph[0]['progress_length_of_line_tobe_shifted_rhs'] ?>">
                                ...
                                <div class="col-md-4">
                                    <p>
                                     ...
                                     <input class="form-control txtQty limittxt_progress" type="text" placeholder="Progress" name="progress_%" value="<?php if(empty($utility_ph)){ echo set_value('progress_%'); }?><?php echo $utility_ph[0]['progress_%'] ?>">
                            ...
                            <div class="row clearfix">
                                 <div class="col-md-4">
                                    <p>
                                        <b>PH/RHS Utility Shifting for A / A Done ? </b>
                                    </p>
                                     <select class="form-control show-tick" name="progress_ph_utility_shifting">
                                        <option value="Yes" <?php echo set_select('progress_ph_utility_shifting','Yes', ( !empty($utility_ph[0]['progress_ph_utility_shifting']) &&
                                      $utility_ph[0]['progress_ph_utility_shifting'] == "Yes" ? TRUE : FALSE )); ?>>Yes</option>
                                        <option value="No" <?php echo set_select('progress_ph_utility_shifting','No', ( !empty($utility_ph[0]['progress_ph_utility_shifting']) &&
                                      $utility_ph[0]['progress_ph_utility_shifting'] == "No" ? TRUE : FALSE )); ?>>No</option>
                                        <option value="In Progress" <?php echo set_select('progress_ph_utility_shifting','In Progress', ( !empty($utility_ph[0]['progress_ph_utility_shifting']) &&
                                      $utility_ph[0]['progress_ph_utility_shifting'] == "In Progress" ? TRUE : FALSE )); ?>>In Progress</option>
                                        <option value="N.A" <?php echo set_select('progress_ph_utility_shifting','N.A', ( !empty($utility_ph[0]['progress_ph_utility_shifting']) &&
                                      $utility_ph[0]['progress_ph_utility_shifting'] == "N.A" ? TRUE : FALSE )); ?>>N.A.</option>
                                    </select>
                                </div>                               
                                ...
                                <div class="col-md-4">
                                    <p>
                                     ...
                                     <input class="form-control txtQty" type="text" placeholder="Amount" name="progress_amount_utilised" value="<?php if(empty($utility_ph)){ echo set_value('progress_amount_utilised'); }?><?php echo number_format($utility_ph[0]['progress_amount_utilised'],2) ?>">
                                ...
                                <div class="col-md-4">
                                    <p>
                                     ...
                                     <input class="form-control txtQty limittxt_progress" type="text" placeholder="pre-construction fund Utilized" name="progress_fund_utilised" value="<?php if(empty($utility_ph)){ echo set_value('progress_fund_utilised'); }?><?php echo $utility_ph[0]['progress_fund_utilised'] ?>">
                            ...
                            <div class="row clearfix">
                                <div class="col-md-4">
                                    ...
                                    <textarea class="form-control no-resize" rows="3" id="maxremarks" placeholder="Please type what you want..." name="remarks"><?php if(empty($utility_ph)){ echo set_value('remarks'); }?><?php echo $utility_ph[0]['remarks'] ?></textarea>
                          ...
                          <div class="col-md-12  align-center">
                            ...
                            <button class="btn btn-primary waves-effect " name="submit" id="submit_btn" value="Submit"  type="submit">
                             <?php echo (empty($utility_ph)) ? 'SAVE' : 'Update' ?>
                            </button>
                           </div>
