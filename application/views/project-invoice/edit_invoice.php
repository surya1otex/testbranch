                        ...
                        <div class="section_clone">
                            <div class="row clearfix cloneBox1">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-line">
                                            <input type="text" id="invoice_no"  value="<?php echo $invoice_details[0]['invoice_no']; ?>" name="invoice_no" class="form-control" placeholder="Invoice No" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-line">
                                            <input type="text" id="invoice_date" value="<?php echo $invoice_details[0]['invoice_date']; ?>" name="invoice_date" class="datepicker form-control" placeholder="Invoice Date">
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-line">
                                            <input type="text" value="<?php echo $invoice_details[0]['total_amount']; ?>" id="total_invoice_amount" name="amount_paid" class="form-control" placeholder="Claimed Amount" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-4">
                                        <select id="invoice_vendor" name="vendor" class="form-control show-tick">
                                            ...
                                            <?php foreach ($vendors as $vendor){ ?>
                                                <?php $str = ''; if( $vendor['id'] == $invoice_details[0]['vendor_id'] ){ $str ="selected";}?>
                                                <option value="<?php echo $vendor['id'];?>" <?php echo $str; ?> ><?php echo $vendor['vendor']; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12 p-l-10 p-r-10">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table id="amount_brkup_tbl" class="table table-bordered table-striped table-hover">
                                                ...
                                                <tbody>
                                                <?php for($j= 0; $j < count($invoice_breakup_details); $j++){ ?>
                                                <tr id="tr_<?php echo $j+1; ?>">

                                                    <td>
                                                        <select name="head[]" class="head form-control show-tick">
                                                            <option value="">Please Select</option>
                                                            <?php foreach ($head as $headList){?>
                                                                <?php $a = ''; if($headList['id'] == $invoice_breakup_details[$j]['major_head_id']){ $a = 'selected';} ?>
                                                                <option value="<?php echo $headList['id']; ?>" <?php echo $a;?> ><?php echo $headList['major_head']; ?></option>
                                                            <?php  } ?>
                                                        </select>
                                                    </td>
                                                    <td> <input name="details[]" require="" type="text" value="<?php echo $invoice_breakup_details[$j]['details'] ?>" class="form-control details"/> </td>
                                                    <td> <input name="amount[]" onkeypress="allowNumbersOnly(event)" require="" type="text" value="<?php echo $invoice_breakup_details[$j]['amount'] ?>" class="form-control amount"/></td>
                                                    <td>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-md-10">
                                        <div class="form-line">
                                            <textarea name="remarks" class="form-control no-resize" placeholder="Please type what you want..."><?php echo $invoice_details[0]['remarks']?></textarea>
                                        </div>
                                    </div>
                                </div>
