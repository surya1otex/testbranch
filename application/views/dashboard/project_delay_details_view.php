               ...
               <div class="row clearfix">
                 ...
                 <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                   <div class="body">
                    ...
                    <form action="<?php echo base_url().'project_summary_list/send_communication_data'; ?>" id="communication_frm" method="POST">
                        <input type="hidden" name="project_id" value="<?php echo $project_id; ?>">
                     <div class="col-md-12 p-t-15">
                        <p><b>Message to : <span class="col-pink">* </span></b></p>
                        <select class="form-control show-tick" name="stakeholder_id" id="stakeholder_id">
                            <option value="">Select</option>
                            <?php
                            if(is_array($project_creation_users)){
                                foreach($project_creation_users as $users){
                            ?>
                            <option value="<?php echo $users->user_id; ?>"><?php echo $users->firstname.' '.$users->lastname.' ('.$users->designation.' )'; ?></option>
                        <?php } } ?>
                        </select>
                      </div>
                      <div class="col-md-12 p-t-15">
...
<script type="text/javascript">
    function get_communication_area(){
        ...
        $.ajax({
                        type: "POST",
                        url: "<?php echo base_url();?>project_summary_list/get_communication_area",
