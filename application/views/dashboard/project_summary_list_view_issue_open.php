                                        ...
                                        ?>
                                         ...
                                         <tr>
                                          ...
                                          <td>
                                            ...
                                            <!-- <td><?php echo $project->closeissue; ?></td> -->
                                          <td>
                                            <a href="<?php echo base_url();?>Projectdashboard/issue_details_open?project_id=<?php echo base64_encode($project->id);?>">
                                            <span class="ntip"><?php echo $project->closeissue;?>
