...
?>
 ...
 <div style="width:100%; margin:15px 15px; text-align:left;">Project Monitoring Dashboard - Reply Required</div>
    <div style="margin:0 15px;">
        ...
        <div style="width:100%; margin:15px 15px; text-align:center;">
            <a href="<?php echo base_url().'?type='.base64_encode('delayed'); ?>" target="_blank" style="background-color: #4C8AAF; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; border-radius:10px 20px;" type="button"> View </a>
