                                ...
                                <table id="project_list" class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        if(is_array($project_list)){
                                         ...
                                         $not_seen_count = $CI->get_stakeholder_not_seen_count_data($project->id);
                                        ...
                                        <tr>
                                           ...
                                           <td><span class="label label-danger"><?php echo round($SV,2); ?></span></td>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?php echo base_url().'project_delay_list/delay_details?project_id='.base64_encode($project->id); ?>" class="btn btn-primary waves-effect view_chnge_st_btn" data-id="<?php echo $project->id; ?>" title="View"><i class="fas fa-eye"></i> View</a><span class="label-count2 bg-red"><?php echo $not_seen_count; ?></span>
                                                </div>
                                            </td>
...
<script type="text/javascript">
  ...
  var id = $(this).data('id');
    ...
    $.ajax({
  type: "POST",
  url: "<?php echo base_url(); ?>project_delay_list/change_seen_status",
  data: "project_id=" +id,
