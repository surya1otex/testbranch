                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="info-box bg-orange hover-expand-effect m-b-0">
                                    ...
                                    <div class="content">
                                        <div class="text">Estimated Amt. (&#8377; <?php echo $all_project_budget_suffix; ?>)</div>
                       ...
                       <div class="">
                         ...
                         <!-- <div class="">
                              ...
                              <div class="">
                               ...
                               <div class="">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <a onclick="project_summary_list('Closed Issue');">
                               ...
                               <div class="">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <a onclick="project_summary_list('Open Issue');">
