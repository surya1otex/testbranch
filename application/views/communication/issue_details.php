                        ...
                        <div class="body">
                            <div class="issue-create-container">
                                <div class="row">
                                    <div class="col-md-3">
                                        <p><b>Issue Name</b></p>
                                        <input class="form-control" type="text" placeholder="Issue Name" value="Issue 1">
                                    </div>
                                    <div class="col-md-3">
                                        <p><b>Issue Owner</b></p>
                            ...
                            <div id="issue-saved-container" class="m-b-15">
                                <div class="row issue-saved-row">
                                        <div class="col-md-3">
                                            <p><b>Issue Name</b></p>
                                            <input class="form-control" type="text" placeholder="Issue Name" value="Issue 2">
                                        </div>
                                        <div class="col-md-3">
                                            <p><b>Issue Owner</b></p>
                                            <select  class="form-control" name="issue-owner">
                                        ...
                                        <div class="col-md-2">
                                            <p><b>Issue Date</b></p>
                                            <input type="text" id="" class="datepicker form-control" placeholder="Please choose a date...">
                                        </div> 
                                        <div class="col-md-1 p-t-25">       <button class="btn btn-default btn-circle waves-effect waves-circle waves-float issue-saved-remove" type="button"><i class="material-icons col-pink">delete</i></button>
                                        </div>
                                </div>
                            </div>
...
<script>
    ...
    $(".issue-add").click(function () {
        $(".issue-create-container").append('<div id="issue-create-row"><div class="row"><div class="col-md-3"><p><b>Issue Name</b></p> <input class="form-control" type="text" placeholder="Issue Name"></div><div class="col-md-3"><p><b>Issue Owner</b></p> <select class="form-control" name="issue-owner"><option value="0">Select Issue Owner</option><option value="1">Works Dept</option><option value="2">External Authority</option> </select></div><div class="col-md-3"><p><b>Upload Document</b></p> <input type="file" name="fileupload" value="fileupload" id="" class="form-control"></div><div class="col-md-2"><p><b>Issue Date</b></p> <input type="text" id="approve" class="datepicker form-control" placeholder="Please choose a date..."></div><div class="col-md-1 p-t-25"> <button class="btn btn-default btn-circle waves-effect waves-circle waves-float issue-remove" type="button"><i class="material-icons col-pink">delete</i></button></div></div></div>');
    });
     ...
     $("#issue-saved-container").on("click", ".issue-saved-remove", function() {
        $(this).closest(".issue-saved-row").remove();
     });
</script>
</body>
</html>