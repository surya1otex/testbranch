...
<section class="content">
        ...
        <div class="block-header">
          <h4>Project Procurement - Pending Approval</h4>
        </div>
            </div>
            <div class="col-md-6">
                                      ...
                                      ?>
                                        <tr>
                                            ...
                                            <td>
                                              ...
                                              ?>
                                                <a href="<?php echo base_url();?>project_approval/approve?project_id=<?php echo base64_encode($app->project_id);?>&stage_id=<?php echo base64_encode($app->stage_id);?>" class="btn btn-success waves-effect" title="Planning"><i class="fas fa-check"></i> Approve</a>
                                                <a href="<?php echo base_url();?>project_approval/reject?project_id=<?php echo base64_encode($app->project_id);?>&stage_id=<?php echo base64_encode($app->stage_id);?>" class="btn btn-danger waves-effect" title="Planning"><i class="fas fa-times"></i> Reject</a>
