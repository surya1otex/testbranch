        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="card">
                    ...
                    <div class="body">
                        <?php echo form_open('Master/add_block',array('name'=> 'add_block','id'=>'add_block')); ?>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <tr>
                                    ...
                                    <th>Block Name<span style="color: red;">*</span> </th>
                                ...
                                <?php //<pre>"; print_r($division_detail_edit);  ?>
                                    <td>
                                        <input type="hidden" name="block_id" value="<?php echo base64_encode($block_id); ?>">

                                        <input type="text" class="form-control" placeholder="Name" required="" name="block_name" value="<?php if(!empty($block_detail_edit[0]['block_name'])){echo $block_detail_edit[0]['block_name'];}else{echo "";}?>"/>
                                    </td>
                                        ...
                                        <select class="form-control show-tick" id="district_id" name="district_id" required="">
                                            ...
                                            <?php foreach ($ar_dist_details as $dist){ ?>
                                                <option value="<?php echo $dist['id']; ?>"
                                                    <?php if(!empty($block_detail_edit) &&($block_detail_edit[0]['district_id']==$dist['id'])){echo "selected";}?>><?php echo $dist['district_name']; ?></option>
                                    ...
                                    <td>
                                        <select class="form-control show-tick" name="status" required="">
                                            <option value="Y" <?php if(!empty($block_detail_edit) &&($block_detail_edit[0]['status']=="Y")){echo "selected";}?>>Active</option>
                                            <option value="N" <?php if(!empty($block_detail_edit) &&($block_detail_edit[0]['status']=="N")){echo "selected";}?>>Inactive</option>
                                        </select>
                                    </td>
                                </tr>
                                </tbody>
                        ...
                        <div class="table-responsive" style="overflow-x: hidden;">
                            <table class="table table-bordered table-striped table-hover js-basic-example-unit-master dataTable">
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: center; vertical-align: middle;">Block Name</th>
                                ...
                                if(!empty($ar_dist_details)){
                                    ...
                                    foreach($ar_destination_details as $unit_details){
                                        ...
                                        <tr>
                                            <td><?php echo $i;?></td>
                                            <td><?php echo $unit_details['block_name'];?></td>
                                            <td><?php echo $unit_details['district_name'];?></td>
                                            <td style="text-align: center; vertical-align: middle;">
                                                <a href="<?php echo site_url(); ?>/Master/block?block_id=<?php echo base64_encode($unit_details['id']); ?>" class="m-r-10 col-black"> <i title="Edit Item" class="fas fa-edit"></i> </a>
...
$(document).ready(function(){
	...
	var blockDIVId = ("<?php if(!empty($block_detail_edit[0]['division_id'])){ echo $block_detail_edit[0]['division_id'];} ?>");
	//alert(collegeStateId);
	view_division(distID,blockDIVId);
