    ...
    <div class="container-fluid">
        <div class="col-md-6">
            <div class="block-header">
                ...
                <h4>Sector Master Management</h4>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="card">
                    ...
                    <div class="body">
                        <?php echo form_open('Master/add_sector',array('name'=> 'add_sector','id'=>'add_sector')); ?>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example-sector-master dataTable">
                                ...
                                <tr>
                                    <td>
                                        <input type="hidden" name="sector_id" value="<?php echo base64_encode($sector_id); ?>">
                        ...
                        <div class="table-responsive" style="overflow-x: hidden;">
                            <table class="table table-bordered table-striped table-hover js-basic-example-unit-master dataTable">
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: center; vertical-align: middle;">Sector Name</th>
                                    ...
                                    foreach($ar_unit_details as $unit_details){
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center; vertical-align: middle;">
                                                <a href="<?php echo site_url(); ?>/Master/sector?sector_id=<?php echo base64_encode($unit_details['id']); ?>" class="m-r-10 col-black"> <i title="Edit Item" class="fas fa-edit"></i> </a>
