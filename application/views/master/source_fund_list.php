    ...
    <div class="container-fluid">
        <div class="col-md-6">
            <div class="block-header">
                ...
                <h4>Source of Fund master Master Management</h4>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="card">
                    <div class="header">
                        <h2>Add a Source of Fund</h2>
                    </div>
                    <div class="body">
                        <?php echo form_open('Master/add_source_of_fund',array('name'=> 'add_source_of_fund','id'=>'add_source_of_fund')); ?>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <tr>
                                    <td>
                                        <input type="hidden" name="sfund_id" value="<?php echo base64_encode($sfund_id); ?>">

                                        <input type="text" class="form-control" placeholder="Name" required="" name="name" value="<?php if(!empty($unit_detail_edit[0]['name'])){echo $unit_detail_edit[0]['name'];}else{echo "";}?>"/>
                                    </td>
                        ...
                        <div class="table-responsive" style="overflow-x: hidden;">
                            <table class="table table-bordered table-striped table-hover js-basic-example-unit-master dataTable">
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: center; vertical-align: middle;">Source of Fund Name</th>
                                    ...
                                    foreach($ar_unit_details as $unit_details){
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center; vertical-align: middle;">
                                                <a href="<?php echo site_url(); ?>/Master/source_of_fund?sfund_id=<?php echo base64_encode($unit_details['id']); ?>" class="m-r-10 col-black"> <i title="Edit Item" class="fas fa-edit"></i> </a>
