    ...
    <div class="container-fluid">
        <div class="col-md-6">
            <div class="block-header">
                ...
                <h4>Circle Master Management</h4>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="card">
                    ...
                    <div class="body">
                        <?php echo form_open('Master/add_wing',array('name'=> 'add_wing','id'=>'add_wing')); ?>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <tr>
                                    <td>
                                        <input type="hidden" name="wing_id" value="<?php echo base64_encode($wing_id); ?>">

                                        <input type="text" class="form-control" placeholder="Name" required="" name="wing_name" value="<?php if(!empty($wing_detail_edit[0]['wing_name'])){echo $wing_detail_edit[0]['wing_name'];}else{echo "";}?>"/>
                                    </td>

                                    <td>
                                        <select class="form-control show-tick" name="status" required="">
                                            <option value="Y" <?php if(!empty($wing_detail_edit) &&($wing_detail_edit[0]['status']=="Y")){echo "selected";}?>>Active</option>
                                            <option value="N" <?php if(!empty($wing_detail_edit) &&($wing_detail_edit[0]['status']=="N")){echo "selected";}?>>Inactive</option>
                                        </select>
                                    </td>
                                </tr>
                                </tbody>
                    ...
                    <div class="body">
                        <div class="">
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: center; vertical-align: middle;">Circle Name</th>
                                ...
                                if(!empty($ar_dis_details)){
                                    ...
                                    foreach($ar_dis_details as $unit_details){
                                        ...
                                        <tr>
                                            <td><?php echo $i;?></td>
                                            <td><?php echo $unit_details['wing_name'];?></td>
                                            <td style="text-align: center; vertical-align: middle;">
                                                <a href="<?php echo site_url(); ?>/Master/wing?wing_id=<?php echo base64_encode($unit_details['id']); ?>" class="m-r-10 col-black"> <i title="Edit Item" class="fas fa-edit"></i> </a>
