        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="card">
                    ...
                    <div class="body">
                        <?php echo form_open('Master/add_area',array('name'=> 'add_area','id'=>'add_area')); ?>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <tr>
                                    <td>
                                        <input type="hidden" name="area_id" value="<?php echo base64_encode($area_id); ?>">

                                        <input type="text" class="form-control" placeholder="Name" required="" name="area_name" value="<?php if(!empty($area_detail_edit[0]['name'])){echo $area_detail_edit[0]['name'];}else{echo "";}?>"/>
                                    </td>

                                    <td>
                                        <select class="form-control show-tick" name="status" required="">
                                            <option value="Y" <?php if(!empty($area_detail_edit) &&($area_detail_edit[0]['status']=="Y")){echo "selected";}?>>Active</option>
                                            <option value="N" <?php if(!empty($area_detail_edit) &&($area_detail_edit[0]['status']=="N")){echo "selected";}?>>Inactive</option>
                                        </select>
                                    </td>
                                </tr>
                                </tbody>
                        ...
                        <div class="table-responsive" style="overflow-x: hidden;">
                            <table class="table table-bordered table-striped table-hover js-basic-example-area-master dataTable">
                                ...
                                if(!empty($ar_area_details)){
                                    $i=1;
                                    foreach($ar_area_details as $unit_details){
                                        ?>
                                        <tr>
                                            <td><?php echo $i;?></td>
                                            <td><?php echo $unit_details['name'];?></td>
                                            <td style="text-align: center; vertical-align: middle;">
                                                <a href="<?php echo site_url(); ?>/Master/area?area_id=<?php echo base64_encode($unit_details['id']); ?>" class="m-r-10 col-black"> <i title="Edit Item" class="fas fa-edit"></i> </a>
