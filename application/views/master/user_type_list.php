    ...
    <div class="container-fluid">
        <div class="col-md-6">
            <div class="block-header">
                ...
                <h4>User Type Master Management</h4>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="card">
                    <div class="header">
                        <h2>Add a User Type</h2>
                    </div>
                    <div class="body">
                        <?php echo form_open('Master/add_user_type',array('name'=> 'add_user_type','id'=>'add_user_type')); ?>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <tr>
                                    <td>
                                        <input type="hidden" name="user_type_id" value="<?php echo base64_encode($user_type_id); ?>">

                                        <input type="text" class="form-control" placeholder="Name" required="" name="name" value="<?php if(!empty($unit_detail_edit[0]['designation'])){echo $unit_detail_edit[0]['designation'];}else{echo "";}?>"/>
                                    </td>
                                    ...
                                    foreach($ar_unit_details as $unit_details){
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center; vertical-align: middle;">
                                                <a href="<?php echo site_url(); ?>/Master/user_type?user_type_id=<?php echo base64_encode($unit_details['id']); ?>" class="m-r-10 col-black"> <i title="Edit Item" class="fas fa-edit"></i> </a>
