    ...
    <div class="container-fluid">
        <div class="col-md-6">
            <div class="block-header">
                ...
                <h4>Village Master Management</h4>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="card">
                    ...
                    <div class="body">
                        <?php echo form_open('Master/add_village',array('name'=> 'add_village','id'=>'add_village')); ?>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <tr>
                                    ...
                                    <th>Village Name<span style="color: red;">*</span> </th>
                                ...
                                <?php //<pre>"; print_r($division_detail_edit);  ?>
                                    <td>
                                        <input type="hidden" name="village_id" value="<?php echo base64_encode($village_id); ?>">

                                        <input type="text" class="form-control" placeholder="Name" required="" name="village_name" value="<?php if(!empty($village_detail_edit[0]['village_name'])){echo $village_detail_edit[0]['village_name'];}else{echo "";}?>"/>
                                    </td>
                                        ...
                                        <select class="form-control show-tick" id="district_id" name="district_id" required="">
                                            ...
                                            <?php foreach ($ar_dist_details as $dist){ ?>
                                                <option value="<?php echo $dist['id']; ?>"
                                                    <?php if(!empty($village_detail_edit) &&($village_detail_edit[0]['district_id']==$dist['id'])){echo "selected";}?>><?php echo $dist['district_name']; ?></option>
                                    ...
                                    <td class="focused">
                                        <select class="form-control show-tick" name="tehsil_id" id="tehsil_id"required="">
                                    ...
                                    <td>
                                        <select class="form-control show-tick" name="status" required="">
                                            <option value="Y" <?php if(!empty($village_detail_edit) &&($village_detail_edit[0]['status']=="Y")){echo "selected";}?>>Active</option>
                                            <option value="N" <?php if(!empty($village_detail_edit) &&($village_detail_edit[0]['status']=="N")){echo "selected";}?>>Inactive</option>
                                        </select>
                                    </td>
                                </tr>
                                </tbody>
                        ...
                        <div class="table-responsive" style="overflow-x: hidden;">
                            <table class="table table-bordered table-striped table-hover js-basic-example-unit-master dataTable">
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: center; vertical-align: middle;">Village Name</th>
                                ...
                                if(!empty($ar_dist_details)){
                                    ...
                                    foreach($ar_destination_details as $unit_details){
                                        ...
                                        <tr>
                                            <td><?php echo $i;?></td>
                                            <td><?php echo $unit_details['village_name'];?></td>
                                            <td><?php echo $unit_details['district_name'];?></td>
                                            <td style="text-align: center; vertical-align: middle;">
                                                <a href="<?php echo site_url(); ?>/Master/village?village_id=<?php echo base64_encode($unit_details['id']); ?>" class="m-r-10 col-black"> <i title="Edit Item" class="fas fa-edit"></i> </a>
...
$(document).ready(function(){
	...
	var villageDIVId = ("<?php if(!empty($village_detail_edit[0]['tahsil_id'])){ echo $village_detail_edit[0]['tahsil_id'];} ?>");
	//alert(collegeStateId);
	view_division(distID,villageDIVId);
	...
	$("#district_id").change(function(){
		...
		$.ajax({
		type: "POST",
		url: "<?php echo base_url(); ?>Master/gettehsilList",
		datatype : 'json',
		...
		success: function(data){
															 ...
															 for (var i = 0; i < parsed_data.all_div.length; i++)
                                      {
										...
										$("#tehsil_id").append("<option  value='" + parsed_data.all_div[i].id  + "'>" + parsed_data.all_div[i].	tahsil_name + "</option>");
										...
										{
										$("#tehsil_id").append("<option  value=''>" +'Select District' + "</option>");
		...
		else
		{
			...
			$('#tehsil_id option').prependTo('<option value=""> Select District</option>');
		}
	});
		...
		success: function(data){
															 ...
															 for (var i = 0; i < parsed_data.all_div.length; i++)
                                      {
										...
										$("#tehsil_id").append("<option  "+ val_selected +" value='" + parsed_data.all_div[i].id  + "'  >" + parsed_data.all_div[i].	tahsil_name + "</option>");
