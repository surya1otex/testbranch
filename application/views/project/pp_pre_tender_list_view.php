                                ...
                                <table id="project_list" class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        if(is_array($project_pending_data)){
                                          ...
                                          $edit_action = base_url().'project/project_pre_tender?project_id='.base64_encode($key->project_id);
                                   ...
                                   <!--  end for pending -->
                                    ...
                                    <?php 
                                        $k = $i; 
                                        if(is_array($pp_pre_tender_data)){
                                            foreach ($pp_pre_tender_data as $key) {
                                          if($key->approve_status == 'Y'){
