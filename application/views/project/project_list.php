...
<section class="content">
        <div class="container-fluid">
           <div class="col-md-6">
            ...
            <div class="col-md-6">
                <a href="<?php echo base_url();?>Project/project_initiation"  class="btn bg-indigo waves-effect pull-right">
                                    ...
                                    <tbody>
                                      ...
                                      ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url(); ?>Project/project_initiation?project_id=<?php echo base64_encode($pro_dtl['id']); ?>" class="m-r-10 col-black"> <i class="fas fa-edit"></i> </a>
