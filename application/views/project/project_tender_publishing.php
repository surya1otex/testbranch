...
<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h4>Project Tender Publishing</h4>
        </div>
    ...
    ?>
                ...
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <div class="row clearfix">
                            <div class="col-md-4">
                                <p>
                                    <b>Tender ID  <span class="col-pink">* </span></b>
                            ...
                            <div class="col-md-4">
                                <p>
                                    <b>Tender Name <span class="col-pink">* </span></b>
                        ...
                        <div class="row clearfix">
                            <div class="col-md-4">
                                <p>
                                    <b>Tender Type (Coverage)</b>
                                   
                                </p>
                                
                                  <select name="tender_type_coverage" class="form-control show-tick">
                                    <option <?php echo ($_REQUEST['tender_type_coverage'] == 'open'|| $result['tender_type_coverage']  == 'open') ? "selected" :''; ?>  value="open">Open</option>
                                    <option <?php echo ($_REQUEST['tender_type_coverage'] == 'closed'|| $result['tender_type_coverage']  == 'closed') ? "selected" :''; ?> value="closed">Closed</option>
                                </select>

                            </div>
                            <div class="col-md-4">
                                <p>
                                    <b>Tender Type (Geography) </b>
                                   
                                </p>
                                 <select name="tender_type_geography" class="form-control show-tick">
                                    <option <?php echo ($_REQUEST['tender_type_geography'] == 'international competitive bidding'|| $result['tender_type_geography']  == 'international competitive bidding') ? "selected" :''; ?>  value="international competitive bidding">International Competitive Bidding</option>
                                    <option <?php echo ($_REQUEST['tender_type_geography'] == 'national competitive bidding'|| $result['tender_type_geography']  == 'national competitive bidding') ? "selected" :''; ?> value="national competitive bidding">National Competitive Bidding</option>
                                </select>

                            </div>
                            <div class="col-md-4">
                                <p>
                                    <b>Tender Type (Procurement) </b>
                                   
                                </p> <select name="tender_type_precurement" class="form-control show-tick">
                        ...
                        <div class="row clearfix">
                            <div class="col-md-4">
                                <p>
                                    <b>Tender Type (Execution)</b>
                                   
                                </p>
                               <select name="tender_type_execution" class="form-control show-tick">
                                    <option <?php echo ($_REQUEST['tender_type_execution'] == 'EPC'|| $result['tender_type_execution']  == 'EPC') ? "selected" :''; ?>  value="EPC">EPC</option>
                                    <option <?php echo ($_REQUEST['tender_type_execution'] == 'turnkey'|| $result['tender_type_execution']  == 'turnkey') ? "selected" :''; ?> value="turnkey">Turnkey</option>
                                    <option <?php echo ($_REQUEST['tender_type_execution'] == 'GCC'|| $result['tender_type_execution']  == 'GCC') ? "selected" :''; ?> value="GCC">GCC</option>
                                </select>

                            </div>
                            <div class="col-md-4">
                                <p>
                                    <b>Tender Publishing Date<span class="col-pink">* </span></b>
                            ...
                            <div class="col-md-4">
                                <p>
                                    <b>Tender Start Date<span class="col-pink">* </span></b>
                        ...
                        <div class="row clearfix">
                            ...
                            class="form-control" placeholder="Enter Put To Tender Value">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>Attachment - Tender Publishing</h2>
                    </div>
