                                ...
                                <table id="project_list" class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        if(is_array($project_pending_data)){
                                          ...
                                          $edit_action = base_url().'project_agreement/manage?project_id='.base64_encode($key->project_id);
                                          $agree_id = $CI->agreement_data_exist_or_not($key->project_id,'id');
                                          if($agree_id > 0){
                                            $draft_mode = $CI->agreement_data_exist_or_not($key->project_id,'draft_mode');
                                            if($draft_mode == 'Y'){
