...
<section class="content">
    <div class="container-fluid">
            ...
            <div class="col-md-12">
                <div class="row ">
                    <ul class="stepper stepper-horizontal p-l-10 p-r-10 m-b-0" >
                        ...
                        <li class="<?php if($project_tender_status){ echo 'completed'; }else{ echo 'gray'; } ?>">
        ...
        <?php echo form_open_multipart('Project/project_pre_tender?project_id='.base64_encode($project_id),array('name'=> 'pre_tender_stage','id'=>'pre_tender_form')); ?>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>Project’s Pre-tender Stage</h2>
                    </div>
                    ...
                    <div class="body">
                        ...
                        <div class="row clearfix">
                            <div class="col-md-4">
                                <p>
                                    <b>Project Re-tendered?  <span class="col-pink">* </span></b>
                                    <span class="ntip"><i class="fa fa-info-circle" title=""></i> <span class="ntiptext">Whether the project has been re-tendered or not.</span>
                                    </span>
                                </p>
                                <select name="project_re_tender" id="project_drop" class="form-control show-tick"  onchange="showDiv(this)">
                                    <option <?php echo ($_REQUEST['project_re_tender'] == 'N'|| $result['re_tender_status']  == 'N') ? "selected" :''; ?> value="N">No</option>
                                    <option <?php echo ($_REQUEST['project_re_tender'] == 'Y'|| $result['re_tender_status']  == 'Y') ? "selected" :''; ?> value="Y" <?php if($project_pre_tender_status == false){ echo "disabled"; } ?>>Yes</option>
                                </select>
                                <span id="err_span" style='color:#ff0000'><?php echo form_error('project_re_tender'); ?></span>

                            </div>
                            <div class="col-md-4">
                                <p>
                                    <b>Tender call number <span class="col-pink">* </span></b>
                                   
                                </p>
                                <input class="form-control" value="<?php echo !empty($result['tender_call_no']) ? $result['tender_call_no'] : $_REQUEST['tender_call_no']; ?>" name="tender_call_no" type="text" placeholder="Enter tender call number">
                                <span id="err_span" style='color:#ff0000'><?php echo form_error('tender_call_no'); ?></span>
                            </div>
                            <div class="col-md-4">
                                <p>
                                    <b>Date of tender approval  (dd/mm/yyyy) <span class="col-pink">* </span></b>
                                  
                                </p>

                                <input type="text" name="tender_approval_date" value="<?php echo !empty($result['tender_approval_date']) ? $result['tender_approval_date'] : $_REQUEST['tender_approval_date']; ?>" id="approve" class="datepicker form-control" placeholder="Please choose a date...">
                                <span id="err_span" style='color:#ff0000'><?php echo form_error('tender_approval_date'); ?></span>
                            </div>
                        ...
                        <div id="dropped" class="row clearfix"  style="display: none;">
                            <div class="col-md-8">
                                <p>
                                    <b>Reason for re-tendering <span class="col-pink">* </span></b>
                                   
                                </p>
                                <input name="retender_reason" value="<?php echo !empty($result['remarks_for_retender']) ? $result['remarks_for_retender']  : $_REQUEST['retender_reason']; ?>" type="text" class="form-control" placeholder="Enter reason for re-tendering">
                                <span id="err_span" style='color:#ff0000'><?php echo form_error('retender_reason'); ?></span>
                        ...
                        <div class="row clearfix">
                            <div class="col-md-4">
                                <p>
                                    <b>Approval obtained for tender document<span class="col-pink">* </span></b>
                                   
                                </p>
                                <select name="tender_doc_approval" class="form-control show-tick">
                                    <option <?php echo ($_REQUEST['tender_doc_approval'] == 'N'|| $result['tender_document_approved']  == 'N') ? "selected" :''; ?>  value="Y">Yes</option>
                                    <option <?php echo ($_REQUEST['tender_doc_approval'] == 'N'|| $result['tender_document_approved']  == 'N') ? "selected" :''; ?> value="N">No</option>
                                </select>

                            </div>
                            <div class="col-md-4">
                                <p>
                                    <b>RFP publish date (dd/mm/yyyy) <span class="col-pink">* </span></b>
                                   
                                </p>

                                <input type="text" name="rfp_publish_date"
                                       value="<?php echo !empty($result['rfp_publishing_date']) ? $result['rfp_publishing_date']  : $_REQUEST['rfp_publish_date']; ?>"
                                       id="approve" class="datepicker form-control" placeholder="Please choose a date...">
                                <span id="err_span" style='color:#ff0000'><?php echo form_error('rfp_publish_date'); ?></span>
                            </div>
                            <div class="col-md-4">
                                <p>
                                    <b>RFP closing date (dd/mm/yyyy) <span class="col-pink">* </span></b>
                                   
                                </p>

                                <input type="text" id="approve" name="rfp_closing_date"
                                       value="<?php echo !empty($result['rfp_closing_date']) ? $result['rfp_closing_date']  : $_REQUEST['rfp_closing_date']; ?>"
                        ...
                        <div class="row clearfix">
                            <div class="col-md-8">
                                ...
                                <input type="text" value="<?php echo !empty($result['remarks']) ? $result['remarks']  : $_REQUEST['remarks']; ?>" name="remarks"  class="form-control" placeholder="Enter remarks">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>Attachment - Project’s Pre-tender</h2>
                    </div>
                   ...
                   // print_r($steps_files);
                    ...
                    <div class="col-md-12 align-center">
                        <button id="submit_btn" class="btn bg-indigo waves-effect"  type="submit" name="submit_btn" id="submit_btn" value="Submit"><?php if($project_pre_tender_status){ echo 'SUBMIT'; }else{ echo 'SUBMIT'; } ?></button>
                        
                        <?php
                        if($result['draft_mode']  == 'Y' || empty($project_pre_tender_status)){
                        ?>
