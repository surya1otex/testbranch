        ...
        <div class="container-fluid">
           <div class="col-md-6">
				<div class="block-header">
					<h4>Project List - Tender Publishing</h4>
				</div>
            </div>
            <div class="col-md-6">
                                ...
                                <table id="project_list" class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        // die;
										   ...
										   $edit_action = base_url().'Project_tender_publishing/manage?project_id='.base64_encode($key->project_id);
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo $edit_action; ?>" <?php echo $modify_btn_class; ?> class="btn bg-red" title="Entry"><i class="fa fa-plus"></i> Entry</a>
                                            </td>
                                        </tr>
