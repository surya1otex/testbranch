...
<section class="content">
    <div class="container-fluid">
        <?php if(!empty($project_id)) {?>
            <?php echo form_open_multipart('project_administrative_approval/manage?project_id='.$project_id,array('name'=> 'project_dpr','id'=> 'project_dpr_form','class'=> 'container-fluid')); ?>
            ...
            <div class="card">
                ...
                <div class="body">
                    ...
                    <div class="row clearfix">
						...
						<div class="col-md-4">
                            <p>
                                <b>Date Of Presentation For Administrative Approval<span class="col-pink">* </span></b>
                            </p>
                            <?php $val = (!empty($_REQUEST['date_of_presentation'])) ? $_REQUEST['date_of_presentation'] : $result['date_of_presentation']; ?>
                            <?php if ($val == '0000-00-00') {
                                $val = '';
                            } ?>
                            <input type="text" name="date_of_presentation"  value="<?php echo $val; ?>" id="date_of_presentation" class="datepicker form-control" placeholder="Please choose a date...">
                            <span style='color:#ff0000'><?php echo form_error('date_of_presentation'); ?></span>
                        </div>
                        <div class="col-md-4">
                            <p>
                                <b>Administrative Approval Date <span class="col-pink">* </span></b>
                            </p>
                            <?php $val = (!empty($_REQUEST['administrative_approval_date'])) ? $_REQUEST['administrative_approval_date'] : $result['administrative_approval_date']; ?>
                            <?php if ($val == '0000-00-00') {
                                $val = '';
                            } ?>
                            <input type="text" name="administrative_approval_date"  value="<?php echo $val; ?>" id="administrative_approval_date" class="datepicker form-control" placeholder="Please choose a date...">
                            <span style='color:#ff0000'><?php echo form_error('administrative_approval_date'); ?></span>
                        </div>
                        <div class="col-md-4">
                            <p>
                                <b>Administrative Approval File No. (Physical And/Or OSWAS Ref) <span class="col-pink">* </span></b>
                            </p>
                           
                            <?php $val = (!empty($_REQUEST['file_no'])) ? $_REQUEST['file_no'] : $result['file_no']; ?>
                            <input type="text" name="file_no"  value="<?php echo $val; ?>" id="file_no" class="form-control" placeholder="">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-md-4">
                            <p>
                                <b>Final Approval Authority <span class="col-pink">* </span></b>
                            </p>
                           
                            <?php $val = (!empty($_REQUEST['final_approval_authority'])) ? $_REQUEST['final_approval_authority'] : $result['final_approval_authority']; ?>
                            <input type="text" name="final_approval_authority"  value="<?php echo $val; ?>" id="final_approval_authority" class="form-control" placeholder="">
                            <span style='color:#ff0000'><?php echo form_error('final_approval_authority'); ?></span>
                        </div>
                        <div class="col-md-4">
                            <p>
                                <b>Approved Project Cost<span class="col-pink">* </span></b>
                            </p>
                           
                            <?php $val = (!empty($_REQUEST['approved_project_cost'])) ? $_REQUEST['approved_project_cost'] : $result['approved_project_cost']; ?>
                            <input type="text" name="approved_project_cost" value="<?php echo number_format($val,2); ?>" id="approved_project_cost" class="form-control" placeholder="">
                            <span style='color:#ff0000'><?php echo form_error('approved_project_cost'); ?></span>
                        </div>
                ...
                <div class="card">
                   ...
                   //print_r($steps_files);
                    ...
                    <div class="col-md-12 align-center">
                        ...
                        <?php
                        if($result['draft_mode']  == 'Y' || empty($Aapproval_status)){
                        ?>
                        <button class="btn btn-success waves-effect" type="submit" name="draft_btn" id="draft_btn" value="Draft">SAVE DRAFT</button>
                    <?php }else{ ?>
                         <a href="<?php echo base_url().'project_list/pip_administrative_approval' ?>" class="btn btn-warning waves-effect">CANCEL</a>
                    <?php } ?>

                    <button id="submit_btn" class="btn bg-indigo waves-effect"  type="submit" name="submit_btn" value="Submit" ><?php if($result['draft_mode']  == 'Y' || empty($Aapproval_status)){ echo 'SUBMIT'; }else{ echo 'UPDATE'; } ?></button>
                    </div>
