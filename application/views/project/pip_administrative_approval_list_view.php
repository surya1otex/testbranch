        ...
        <div class="container-fluid">
           <div class="col-md-6">
				<div class="block-header">
					<h4>Project List - Administrative Approval</h4>
				</div>
            </div>
            <div class="col-md-6">
                                ...
                                <table id="project_list" class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        if(is_array($project_pending_data)){
                                          ...
                                          $edit_action = base_url().'project_administrative_approval/manage?project_id='.base64_encode($key->project_id);
                                   ...
                                   <!--  end for pending -->
                                    ...
                                    <?php 
                                        $k = $i; 
                                        if(is_array($pip_administrative_data)){
                                            foreach ($pip_administrative_data as $key) {
                                          if($key->approve_status == 'Y'){
