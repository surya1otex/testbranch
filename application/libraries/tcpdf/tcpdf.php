...
class TCPDF {
	...
	public function Footer() {
		...
		if (empty($this->pagegroups)) {
			...
			$pagenumtxt = ' Created on ' .$dt->format('d/M/Y, H:i:s').'   '.$this->l['w_page'].' '.$this->getAliasNumPage().' / '.$this->getAliasNbPages();

		} else {
			//$pagenumtxt = $w_page.$this->getPageNumGroupAlias().' / '.$this->getPageGroupAlias();
			$pagenumtxt = ' Created on ' .$dt->format('d/M/Y, H:i:s').'   '. $this->l['w_page'].' '.$this->getPageNumGroupAlias().' / '.$this->getPageGroupAlias();
