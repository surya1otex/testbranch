...
class Pre_consttruction_activity_utility_shifting_ph extends MY_Controller
{   
    ...
    $projectData_exist_flag = $this->Utility_shifting_ph_model->checkProjectExits($project_id);
        ...
        if ($this->form_validation->run() == FALSE) {
           ...
           $this->load->common_template('pre_consttruction_activity/pre_consttruction_activity_utility_shifting_ph', $data);
        ...
        if($submit == 'Submit'){
            ...
            $db_data['progress_ph_utility_shifting'] = $_REQUEST['progress_ph_utility_shifting'];
