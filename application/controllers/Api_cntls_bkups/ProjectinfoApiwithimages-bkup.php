...
// image upload section
    ...
    $f_name = preg_replace('/\s+/', '_', $_FILES['earnedimages']['name'][$key]);
               ...
               // Check file size
                if ($_FILES["earnedimages"]["size"][$key] > 50000000) {
                 $sizeOk = 0;
                }
                else {
                    $sizeOk = 1;
       ...
       // Allow certain file formats
         ...
         // Check if $uploadOk is set to 0 by an error
            if ($sizeOk == 0 || $uploadOk == 0) {
                ...
                move_uploaded_file($_FILES["earnedimages"]["tmp_name"][$key], $target_file);
            ...
            $earnedimage['image'] = $_FILES['earnedimages']['name'][$key];
